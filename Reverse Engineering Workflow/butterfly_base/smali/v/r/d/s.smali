...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lv/r/d/s;->mLinearInterpolator:Landroid/view/animation/LinearInterpolator;
    ...
    iput-object v0, p0, Lv/r/d/s;->mDecelerateInterpolator:Landroid/view/animation/DecelerateInterpolator;

    const/4 v0, 0x0

    .line 4
    iput-boolean v0, p0, Lv/r/d/s;->mHasCalculatedMillisPerPixel:Z

    .line 5
    iput v0, p0, Lv/r/d/s;->mInterimTargetDx:I

    iput v0, p0, Lv/r/d/s;->mInterimTargetDy:I
    ...
    iput-object p1, p0, Lv/r/d/s;->mDisplayMetrics:Landroid/util/DisplayMetrics;
...
.method public calculateTimeForDeceleration(I)I
    ...
    .line 1
    invoke-virtual {p0, p1}, Lv/r/d/s;->calculateTimeForScrolling(I)I
...
.method public calculateTimeForScrolling(I)I
    ...
    .line 2
    iget-boolean v0, p0, Lv/r/d/s;->mHasCalculatedMillisPerPixel:Z

    if-nez v0, :cond_0

    .line 3
    iget-object v0, p0, Lv/r/d/s;->mDisplayMetrics:Landroid/util/DisplayMetrics;

    invoke-virtual {p0, v0}, Lv/r/d/s;->calculateSpeedPerPixel(Landroid/util/DisplayMetrics;)F

    move-result v0

    iput v0, p0, Lv/r/d/s;->mMillisPerPixel:F
    ...
    .line 5
    :cond_0
    iget v0, p0, Lv/r/d/s;->mMillisPerPixel:F
...
.method public onTargetFound(Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView$a0;Landroidx/recyclerview/widget/RecyclerView$z$a;)V
    ...
    .line 1
    iget-object p2, p0, Lv/r/d/s;->mTargetVector:Landroid/graphics/PointF;
    ...
    .line 2
    :goto_1
    iget-object p2, p0, Landroidx/recyclerview/widget/RecyclerView$z;->mLayoutManager:Landroidx/recyclerview/widget/RecyclerView$o;
    ...
    .line 9
    invoke-virtual/range {v4 .. v9}, Lv/r/d/s;->calculateDtToFit(IIIII)I
    ...
    .line 10
    :goto_3
    iget-object v4, p0, Lv/r/d/s;->mTargetVector:Landroid/graphics/PointF;
    ...
    .line 20
    invoke-virtual {p0, p1}, Lv/r/d/s;->calculateTimeForDeceleration(I)I
    ...
    .line 21
    iget-object v1, p0, Lv/r/d/s;->mDecelerateInterpolator:Landroid/view/animation/DecelerateInterpolator;
