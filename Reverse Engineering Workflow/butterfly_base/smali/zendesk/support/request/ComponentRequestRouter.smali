...
# direct methods
.method public constructor <init>(Lv/b/k/i;Landroid/view/ViewGroup;Lzendesk/support/request/RequestViewConversationsDisabled;Lzendesk/support/request/RequestViewConversationsEnabled;Lzendesk/support/request/RequestViewLoading;Lzendesk/support/request/RequestComponent;Z)V
    .locals 0
    ...
    .line 2
    iput-object p1, p0, Lzendesk/support/request/ComponentRequestRouter;->activity:Lv/b/k/i;
...
.method public final varargs displayView(Landroid/view/View;[Landroid/view/View;)V
    ...
    invoke-direct {v1}, Lv/u/d;-><init>()V

    invoke-static {v0, v1}, Lv/u/n;->a(Landroid/view/ViewGroup;Lv/u/j;)V
    ...
    .line 5
    :cond_0
    iget-object p1, p0, Lzendesk/support/request/ComponentRequestRouter;->activity:Lv/b/k/i;

    invoke-virtual {p1}, Lv/b/k/i;->invalidateOptionsMenu()V

    .line 6
    iget-object p1, p0, Lzendesk/support/request/ComponentRequestRouter;->root:Landroid/view/ViewGroup;

    .line 7
    sget-object p2, Lv/u/n;->c:Ljava/util/ArrayList;
    ...
    .line 15
    invoke-virtual {v1, p1}, Lv/u/j;->a(Landroid/view/ViewGroup;)V
