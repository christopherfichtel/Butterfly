...
.method public static getHandler(Z)Landroid/os/Handler;
    .locals 1

    if-eqz p0, :cond_1

    .line 1
    sget-object p0, La/b/a/k;->c:Landroid/os/Handler;
    ...
    .line 5
    invoke-static {p0, v0}, La/b/a/k;->a(Landroid/os/Looper;Z)Landroid/os/Handler;

    move-result-object p0

    sput-object p0, La/b/a/k;->c:Landroid/os/Handler;
    ...
    .line 7
    :cond_1
    sget-object p0, La/b/a/k;->a:Landroid/os/Handler;
