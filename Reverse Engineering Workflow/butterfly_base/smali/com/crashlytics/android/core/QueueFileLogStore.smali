...
# instance fields
.field public logFile:Ly/a/a/a/q/b/v;
...
.method private doWriteToLog(JLjava/lang/String;)V
    ...
    .line 1
    iget-object v1, p0, Lcom/crashlytics/android/core/QueueFileLogStore;->logFile:Ly/a/a/a/q/b/v;
    ...
    .line 9
    iget-object p2, p0, Lcom/crashlytics/android/core/QueueFileLogStore;->logFile:Ly/a/a/a/q/b/v;

    invoke-virtual {p2, p1}, Ly/a/a/a/q/b/v;->a([B)V

    .line 10
    :goto_0
    iget-object p1, p0, Lcom/crashlytics/android/core/QueueFileLogStore;->logFile:Ly/a/a/a/q/b/v;

    invoke-virtual {p1}, Ly/a/a/a/q/b/v;->b()Z
    ...
    invoke-virtual {p1}, Ly/a/a/a/q/b/v;->r()I
    ...
    invoke-virtual {p1}, Ly/a/a/a/q/b/v;->c()V
    :try_end_0
    ...
    invoke-interface {p2, p3, v0, p1}, Ly/a/a/a/n;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private getLogBytes()Lcom/crashlytics/android/core/QueueFileLogStore$LogBytes;
    ...
    .line 3
    iget-object v0, p0, Lcom/crashlytics/android/core/QueueFileLogStore;->logFile:Ly/a/a/a/q/b/v;
    ...
    .line 5
    :try_start_0
    iget-object v3, p0, Lcom/crashlytics/android/core/QueueFileLogStore;->logFile:Ly/a/a/a/q/b/v;
    ...
    invoke-virtual {v3, v4}, Ly/a/a/a/q/b/v;->a(Ly/a/a/a/q/b/v$d;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-interface {v4, v5, v6, v3}, Ly/a/a/a/n;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private openLogFile()V
    ...
    .line 2
    :try_start_0
    new-instance v0, Ly/a/a/a/q/b/v;

    iget-object v1, p0, Lcom/crashlytics/android/core/QueueFileLogStore;->workingFile:Ljava/io/File;

    invoke-direct {v0, v1}, Ly/a/a/a/q/b/v;-><init>(Ljava/io/File;)V

    iput-object v0, p0, Lcom/crashlytics/android/core/QueueFileLogStore;->logFile:Ly/a/a/a/q/b/v;
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public closeLogFile()V
    ...
    invoke-static {v0, v1}, Ly/a/a/a/q/b/j;->a(Ljava/io/Closeable;Ljava/lang/String;)V
