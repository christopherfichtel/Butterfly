...
# static fields
.field public static c:La/i/b/g/f0;
...
.method public static a(Landroid/content/BroadcastReceiver;Landroid/content/Context;Landroid/content/Intent;)I
    ...
    .line 5
    invoke-static {p1, v0}, Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;->a(Landroid/content/Context;Ljava/lang/String;)La/i/b/g/f0;
    ...
    invoke-virtual {p1, p2, p0}, La/i/b/g/f0;->a(Landroid/content/Intent;Landroid/content/BroadcastReceiver$PendingResult;)V

    return v1
.end method

.method public static declared-synchronized a(Landroid/content/Context;Ljava/lang/String;)La/i/b/g/f0;
    .locals 2
    ...
    .line 7
    :try_start_0
    sget-object v1, Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;->c:La/i/b/g/f0;

    if-nez v1, :cond_0

    .line 8
    new-instance v1, La/i/b/g/f0;

    invoke-direct {v1, p0, p1}, La/i/b/g/f0;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    sput-object v1, Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;->c:La/i/b/g/f0;

    .line 9
    :cond_0
    sget-object p0, Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;->c:La/i/b/g/f0;
    :try_end_0
...
.method public final c(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-virtual {v0, p1, p2}, La/i/b/g/w;->a(Landroid/content/Context;Landroid/content/Intent;)I
